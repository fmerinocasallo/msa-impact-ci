...
def main () :
    ...
    # BEWARE! We are using this OrderedDict for regex matching and the order of
    # its items  matters. You should always include first those haplogroups
    # with longer name. That way, it will match them correctly. For example, if
    # we have both 'R' and 'R0' haplogroups, 'R0' must be added first to the
    # OrderedDict.
